...
import kotlinx.android.synthetic.main.fragment_follow_up_tomorrow_lists.view.*
import org.threeten.bp.ZoneOffset
import org.threeten.bp.ZonedDateTime

class FollowUpTomorrowListsFragment : Fragment() {
    ...
    private val followUpQuery by lazy {
        DispergoDatabase.allFollowUpsView(context!!).createQuery().apply {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        followUp.observe(viewLifecycleOwner, Observer { it ->
            allFollowUpAdapter.submitList(it?.sortedBy { it?.record?.dateFollowUp })
        })

        return inflater.inflate(R.layout.fragment_follow_up_tomorrow_lists, container, false).apply {
            tomorrowFollowUpsRecyclerView.apply {
