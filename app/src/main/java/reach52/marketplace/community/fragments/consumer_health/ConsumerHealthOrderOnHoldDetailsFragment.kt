...
import kotlinx.android.synthetic.main.fragment_consumer_health_order_on_hold_details.*
import org.threeten.bp.format.DateTimeFormatter
import java.util.*

class ConsumerHealthOrderOnHoldDetailsFragment : Fragment() {

    companion object{
        private const val KEY_CONSUMER_ORDER_ID = "consumerOrderId"
        fun newInstance(consumerOrderId: String) : ConsumerHealthOrderOnHoldDetailsFragment{
            return ConsumerHealthOrderOnHoldDetailsFragment().apply {
...
//    }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        return inflater.inflate(R.layout.fragment_consumer_health_order_on_hold_details, container, false)
    }

    @ExperimentalUnsignedTypes
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        super.onActivityCreated(savedInstanceState)
        consumerOrderItemsView.layoutManager = androidx.recyclerview.widget.LinearLayoutManager(activity)
    ...
    private fun displayOrder(order: ConsumerHealthOrder) {
        ...
        consumerOrderItemsView.adapter = ConsumerHealthOrderLinesAdapter(order.orderLines)
...
//                OrderStatus.Status.DISPATCHED -> consumerHealthOrderDB.dispatched(consumerOrderId, user, ::displayOrder)
//                OrderStatus.Status.RECEIVED -> consumerHealthOrderDB.receive(consumerOrderId, user, ::displayOrder)
//                OrderStatus.Status.ACCEPTED -> consumerHealthOrderDB.accept(consumerOrderId, user, ::displayOrder)
//                else -> {
//                    // NOOP
//                }
//            }
