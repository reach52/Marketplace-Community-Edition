...
import kotlinx.android.synthetic.main.fragment_consumer_health_order_delivered_details.*
import org.threeten.bp.format.DateTimeFormatter
import java.util.*

class ConsumerHealthOrderDeliveredDetailsFragment : androidx.fragment.app.Fragment() {

    companion object{
        private const val KEY_CONSUMER_ORDER_ID = "consumerOrderId"

        fun newInstance(consumerOrderId: String) : ConsumerHealthOrderDeliveredDetailsFragment{
            return ConsumerHealthOrderDeliveredDetailsFragment().apply {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        (activity as AppCompatActivity).supportActionBar?.title = getString(R.string.delivered_details)
        return inflater.inflate(R.layout.fragment_consumer_health_order_delivered_details, container, false)
    }
