...
class ConsumerHealthOrderRejectedDetailsFragment : androidx.fragment.app.Fragment() {

    companion object{
        private const val KEY_CONSUMER_ORDER_ID = "consumerOrderId"

        fun newInstance(consumerOrderId: String) : ConsumerHealthOrderRejectedDetailsFragment{
            return ConsumerHealthOrderRejectedDetailsFragment().apply {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        return inflater.inflate(R.layout.fragment_consumer_health_order_rejected_details, container, false)
    }
