...
class ReceivedOrdersDetailsFragment : androidx.fragment.app.Fragment() {

    companion object {
        private const val KEY_ORDER_ID = "orderId"

        fun newInstance(orderId: String): ReceivedOrdersDetailsFragment {
            return ReceivedOrdersDetailsFragment().apply {
...
//    }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        return inflater.inflate(R.layout.fragment_received_orders_details, container, false)
    }
...
//            orders.receive(orderId, user, ::displayOrder)
//            activity?.onBackPressed()
//        }
