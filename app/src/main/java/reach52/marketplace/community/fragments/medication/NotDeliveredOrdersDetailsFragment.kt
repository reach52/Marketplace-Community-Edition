...
class NotDeliveredOrdersDetailsFragment : androidx.fragment.app.Fragment() {

    companion object {
        private const val KEY_ORDER_ID = "orderId"

        fun newInstance(orderId: String): NotDeliveredOrdersDetailsFragment {
            return NotDeliveredOrdersDetailsFragment().apply {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        return inflater.inflate(R.layout.fragment_not_delivered_orders_details, container, false)
    }
