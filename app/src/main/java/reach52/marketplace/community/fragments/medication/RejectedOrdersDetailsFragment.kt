...
import kotlinx.android.synthetic.main.fragment_rejected_orders_details.*
import org.threeten.bp.format.DateTimeFormatter
import java.util.*

@ExperimentalUnsignedTypes
class RejectedOrdersDetailsFragment : androidx.fragment.app.Fragment() {

    companion object {
        private const val KEY_ORDER_ID = "orderId"

        fun newInstance(orderId: String): RejectedOrdersDetailsFragment {
            return RejectedOrdersDetailsFragment().apply {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        (activity as AppCompatActivity).supportActionBar?.title = getString(R.string.orders_rejected_details)
        return inflater.inflate(R.layout.fragment_rejected_orders_details, container, false)
    }
...
//        subTotalTextView.text = order.items.list.map { it.basePriceTotal }.sum().toPhilippinesCurrency()
//        order.discount.fold({
