...
import kotlinx.android.synthetic.main.fragment_received_orders_details.*
import org.threeten.bp.format.DateTimeFormatter
import java.util.*


class ConsumerHealthOrderReceivedDetailsFragment : androidx.fragment.app.Fragment() {

    companion object{
        private const val KEY_CONSUMER_ORDER_ID = "consumerOrderId"
        fun newInstance(consumerOrderId: String) : ConsumerHealthOrderReceivedDetailsFragment{
            return ConsumerHealthOrderReceivedDetailsFragment().apply {
...
//    }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        (activity as AppCompatActivity).supportActionBar?.title = getString(R.string.dispatched_order_details)
        return inflater.inflate(R.layout.fragment_consumer_health_order_recieved_details, container, false)
    }
...
//        dispatchedHoldButton.setOnClickListener {
//            consumerHealthOrderDB.hold(consumerOrderId, user, ::displayOrder)
//            activity?.onBackPressed()
//        }
//
//        receiveDispatchButton.setOnClickListener {
//            consumerHealthOrderDB.receive(consumerOrderId, user, ::displayOrder)
//            activity?.onBackPressed()
//        }
    }
