...
class AcceptedOrderDetailsFragment : androidx.fragment.app.Fragment() {

    companion object {
        private const val KEY_ORDER_ID = "orderId"
        fun newInstance(orderId: String): AcceptedOrderDetailsFragment {
            return AcceptedOrderDetailsFragment().apply {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        (activity as AppCompatActivity).supportActionBar?.title = getString(R.string.accepted_order_details)
        return inflater.inflate(R.layout.fragment_accepted_order_details, container, false)
    }
