...
import kotlinx.android.synthetic.main.fragment_not_delivered_orders_details.*
import org.threeten.bp.format.DateTimeFormatter
import java.util.*

class ConsumerHealthOrderNotDeliveredDetailsFragment : Fragment() {

    companion object{
        private const val KEY_CONSUMER_ORDER_ID = "consumerOrderId"

        fun newInstance(consumerOrderId: String) : ConsumerHealthOrderNotDeliveredDetailsFragment{
            return ConsumerHealthOrderNotDeliveredDetailsFragment().apply {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        (activity as AppCompatActivity).supportActionBar?.title = getString(R.string.not_delivered_details)
        return inflater.inflate(R.layout.fragment_consumer_health_order_not_delivered_details, container, false)
    }
