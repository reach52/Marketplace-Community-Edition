...
import reach52.marketplace.community.adapters.medication.OrderItemAdapter
...
class DeliveredOrdersDetailsFragment : androidx.fragment.app.Fragment() {

    companion object {
        private const val KEY_ORDER_ID = "orderId"

        fun newInstance(orderId: String): DeliveredOrdersDetailsFragment {
            return DeliveredOrdersDetailsFragment().apply {
