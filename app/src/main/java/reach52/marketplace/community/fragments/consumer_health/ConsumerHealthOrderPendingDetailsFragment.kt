...
import kotlinx.android.synthetic.main.fragment_consumer_health_order_pending_details.*
import org.threeten.bp.format.DateTimeFormatter
import java.util.*

class ConsumerHealthOrderPendingDetailsFragment : androidx.fragment.app.Fragment() {
    companion object{
        private const val KEY_CONSUMER_ORDER_ID = "consumerOrderId"

        fun newInstance(consumerOrderId: String) : ConsumerHealthOrderPendingDetailsFragment{
            return ConsumerHealthOrderPendingDetailsFragment().apply {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        return inflater.inflate(R.layout.fragment_consumer_health_order_pending_details, container, false)
    }
    ...
    private fun displayOrder(order: ConsumerHealthOrder) {
        ...
        patientNameTextView.text = order.customer.firstName.plus("").plus(order.customer.middleName).plus("").plus(order.customer.lastName)
