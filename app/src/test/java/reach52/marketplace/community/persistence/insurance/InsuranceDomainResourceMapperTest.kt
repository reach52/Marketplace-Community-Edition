...
class InsuranceDomainResourceMapperTest {
    private val mapper = InsuranceDomainResourceMapper()

    private val insuranceFixture = InsuranceDomainResource(
            identifier = "id123",
            name = "AWH",
            code = "code123",
    ...
    private val mapFixture = mapOf(
            InsuranceDomainResourceMapper.KEY_IDENTIFIER to "id123",
