...
class InsuredDomainResourceMapperTest {
    private val insuredDomainResourceFixture = InsuredDomainResource(
    ...
    private val mapFixture = mapOf(
            ...
            InsuredDomainResourceMapper.KEY_INSURED_CONTACT to "09213212312",
    ...
    @Test
    fun unmarshal() {
        assertEquals(insuredDomainResourceFixture, InsuredDomainResourceMapper().unmarshal(mapFixture))
    }

    @Test
    fun marshal() {
        assertEquals(mapFixture, InsuredDomainResourceMapper().marshal(insuredDomainResourceFixture))
    }
